...
class DataSplitter:
    ...
    def describe_temporal_split(
        ...
        -------
        dict
            Per-window row count and date bounds, plus the strategy name.
            All values are JSON-serialisable. The dataset is unlabelled, so
            there is no fraud count to report.
        """
